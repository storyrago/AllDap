 ...
 * 403 을 주면 "그 봇은 존재한다"를 알려주는 셈이라, id 를 던져
 * 403 만 골라내면 남의 봇 존재 여부를 훑을 수 있기 때문이다.
 *
 * 🔴 2026-09-13 BIGINT 전환으로 이 논거가 <훨씬 강해졌다>. id 가 UUID 였을 때는
 * 훑을 후보가 2^122 개라 무작위 대입이 현실적이지 않았지만, 이제 1·2·3 이라
 * <전부 세어볼 수 있다>. 서버 404 본문이 셋(없는 봇·남의 봇·데모 봇) 다 같다는 것을
 * 2026-09-13 에 실측했고, 이 화면이 그 마지막 한 겹이다.
