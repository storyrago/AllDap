  ...
  return (
    <div className="mx-auto w-full max-w-5xl px-6 py-12">
      <PageIntro
        ...
        /* 🔴 이 페이지의 lead 만 남겼다 (2026-09-08). 다른 공개 페이지의 lead 는 제품 철학을
              설득하는 문장이라 전부 지웠는데, 여기 것은 <문서가 몇 개인지>라는 사실과
              <어떻게 쓰는지>라는 사용법이다 — 없으면 방문자가 이 화면에서 무엇을 해야 할지 모른다.
              대신 "없는 내용은 지어내지 않고 거절합니다" 라는 주장은 뺐다. 그건 말할 것이 아니라
              직접 물어보면 드러나는 것이고, 이 페이지가 존재하는 이유가 정확히 그것이다. */
        lead={
          docs.length > 0
            ? `문서 ${docs.length}개를 학습했습니다. 왼쪽에서 문서를 열어 답과 대조해 보세요.`
